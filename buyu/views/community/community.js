...
myapp.controller('communityCtrl',function($scope,$http,$ionicScrollDelegate){
    ...
    $scope.data=[
        ...
        },
        {
            ...
            "pic":"images/com_pic_06.jpg",
            "attention":856,
            "comment":138
        },
        {
            "head":"images/pic_03.jpg",
            "name":"3X工作室",
            "time":"2016.07.15",
            "title":"做一个安静的铁匠",
            "text":"凡是讲究个招牌，对自己做一辈子的行当不能马虎，那是面子，以匠人的态度为中国人做一份讲究的“中国礼”。让世界...",
            "pic":"images/com_pic_08.jpg",
            "attention":468,
            "comment":68
        },
        {
    ...
    $scope.loadMore=function(){
        $http.get('views/community/community.json').success(function(data){
    ...
    $scope.support=function(item){
        ...
        item.attentioned=true;
    };

    //点击标题滑出副标题导航栏
    $scope.subheadOn=function(){
        $('#subhead_community').slideToggle()
    }
